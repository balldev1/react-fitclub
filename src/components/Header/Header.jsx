    ...
    <div className="header">
      ...
      {menuOpened === false && mobile === true ? (
        ...
        <ul className="header-menu">
          ...
          <li ><Link onClick={()=> setMenuOpened (false)} to='plans' span={true}  smooth={true} >Plans</Link>Plans</li>
          <li><Link  onClick={()=> setMenuOpened (false)} to='testimonials' span={true}smooth={true}>Testtimonials</Link></li>
        </ul>
      )}
    </div>
  );
